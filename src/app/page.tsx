      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl mx-auto">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 text-center hover:shadow-lg transition-shadow duration-200">
              ...
              <div className="space-y-2 text-sm">
                <p><span className="font-large">Status:</span> Enrolled Student</p>
            ...
            <div className="bg-blue-50 dark:bg-yellow-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 text-center">
              <div className="flex items-center justify-between mb-3">
